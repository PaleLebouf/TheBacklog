...
export default class NavBar extends Component {
  ...
  handleChange(event) {
    this.setState({setAuth : event.target.checked});
  }

  handleMenu(event) {
    this.setState({setAnchorEl : event.target.value})
  }
  ...
  render () {
    ...
    <div className= {this.useStyles}>
      <FormGroup>
        <FormControlLabel
          control={<Switch checked={this.state.auth} onChange={this.state.handleChange} aria-label="login switch" />}
